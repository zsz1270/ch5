...
class DBUpdater:
    ...
    def read_naver(self,code,company,pages_to_fetch):
        ...
        try:
            url = f"http://finance.naver.com/item/size_day.nhn?code={code}"
            ...
            df = df.rename(colums={'날짜':'date','종가':'close','전일비':'diff','시가':'open','고가':'high',
                                   '저가':'low','거래량':'volume'})
    ...
    def replace_into_db(self,df,num,code,company):
        ...
        with self.comm.cursor() as curs:
            for r in df.itertuples():
                sql = "REPLACE INTO daily_price VALUES ('{}','{}'.{}.{},{},{},{},{})"
                    .format(code, r.date, r.open, r.high, r.low, r.close, r.dfff, r.volume)
                curs.execute(sql)
            self.conn.commit()
    ...
    def execute_daily(self):
        ...
        if tmnow.month == 12 and tmnow.day == lastday:
            ...
            tmnext = tmnow.replace(day=tmnow.day,hour=17,minute=0,second=0)
        tmdiff = tmnext - tmnow
        secs = tmdiff.seconds
